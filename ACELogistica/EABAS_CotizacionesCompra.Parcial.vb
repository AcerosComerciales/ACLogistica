...
#Region " Campos "
    ...
    Private m_cotco_pesototal As Decimal
    Private m_cotco_observaciones As String

    Private m_cotco_cotizacionproveedor As String
    ...
    Private m_pedidco_codigo As String
...
#Region" Propiedades "
	...
	Public Property COTCO_Estado() As String
		...
		End Set
	End Property
    Public Property COTCO_PesoTotal() As Decimal
		Get
			return m_cotco_pesototal
		End Get
		Set(ByVal value As Decimal)
			If Not IsNothing(m_cotco_pesototal) Then
				If Not m_cotco_pesototal.Equals(value) Then
					m_cotco_pesototal = value
					OnCOTCO_PesoTotalChanged(m_cotco_pesototal, EventArgs.Empty)
				End If
			Else
				m_cotco_pesototal = value
				OnCOTCO_PesoTotalChanged(m_cotco_pesototal, EventArgs.Empty)
		...
		End Set
	End Property
    Public Property COTCO_Observaciones() As String
		Get
			return m_cotco_observaciones
		End Get
		Set(ByVal value As String)
			If Not IsNothing(m_cotco_observaciones) Then
				If Not m_cotco_observaciones.Equals(value) Then
					m_cotco_observaciones = value
					OnCOTCO_ObservacionesChanged(m_cotco_observaciones, EventArgs.Empty)
				End If
			Else
				m_cotco_observaciones = value
				OnCOTCO_ObservacionesChanged(m_cotco_observaciones, EventArgs.Empty)
		...
		End Set
	End Property
    'm_cotco_cotizacionproveedor
    Public Property COTCO_CotizacionProveedor() As String
        Get
            Return m_cotco_cotizacionproveedor
        End Get
        Set(ByVal value As String)
            If Not IsNothing(m_cotco_cotizacionproveedor) Then
                If Not m_cotco_cotizacionproveedor.Equals(value) Then
                    m_cotco_cotizacionproveedor = value
                    OnCOTCO_ObservacionesChanged(m_cotco_cotizacionproveedor, EventArgs.Empty)
                End If
            Else
                m_cotco_cotizacionproveedor = value
                OnCOTCO_ObservacionesChanged(m_cotco_cotizacionproveedor, EventArgs.Empty)
    ...
    Public Property PEDIDCO_Codigo() As String
        Get
            Return m_pedidco_codigo
        End Get
        Set(ByVal value As String)
            If Not IsNothing(m_pedidco_codigo) Then
                If Not m_pedidco_codigo.Equals(value) Then
                    m_pedidco_codigo = value
                    OnPEDIDCO_CodigoChanged(m_pedidco_codigo, EventArgs.Empty)
                End If
            Else
                m_pedidco_codigo = value
                OnPEDIDCO_CodigoChanged(m_pedidco_codigo, EventArgs.Empty)
...
#Region " Eventos "
    ...
    Public Event COTCO_PesoTotalChanged As EventHandler
    Public Event COTCO_ObservacionesChanged As EventHandler
    Public Event COTCO_CotizacionProveedorChanged As EventHandler


    Public Event PEDIDCO_CodigoChanged As EventHandler
	...
	End Sub
    Public Sub OnCOTCO_PesoTotalChanged(ByVal sender As Object, ByVal e As EventArgs)
        ActualizarInstancia()
        RaiseEvent COTCO_PesoTotalChanged(sender,e)
    End Sub
        Public Sub OnCOTCO_ObservacionesChanged(ByVal sender As Object, ByVal e As EventArgs)
        ActualizarInstancia()
        RaiseEvent COTCO_ObservacionesChanged(sender,e)
    End Sub
    Public Sub OnCOTCO_CotizacionProveedorChanged(ByVal sender As Object, ByVal e As EventArgs)
        ActualizarInstancia()
        RaiseEvent COTCO_CotizacionProveedorChanged(sender, e)
    End Sub


    Public Sub OnPEDIDCO_CodigoChanged(ByVal sender As Object, ByVal e As EventArgs)
        ActualizarInstancia()
        RaiseEvent PEDIDCO_CodigoChanged(sender,e)
