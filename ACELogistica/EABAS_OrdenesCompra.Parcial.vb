...
#Region " Campos "
    ...
    Private m_ordco_destino As Short
    Private m_ordco_destino_descripcion As String
    Private m_ordco_cotizacionproveedor As String
...
#Region" Propiedades "
    ...
    Public Property ORDCO_DESTINO_Descripcion() As String
        Get
            Return m_ordco_destino_descripcion
        End Get
        Set(ByVal value As String)
            If Not IsNothing(m_ordco_destino_descripcion) Then
                If Not m_ordco_destino_descripcion.Equals(value) Then
                    m_ordco_destino_descripcion = value
                    OnORDCO_DestinoDescripcionChanged(m_ordco_destino_descripcion, EventArgs.Empty)
                End If
            Else
                m_ordco_destino_descripcion = value
                OnORDCO_DestinoDescripcionChanged(m_ordco_destino_descripcion, EventArgs.Empty)
    ...
    Public Property ORDCO_Estado() As String
        ...
        End Set
    End Property
    Public Property ORDCO_Destino() As Short
        Get
            Return m_ordco_destino
        End Get
        Set(ByVal value As Short)
            If Not IsNothing(m_ordco_destino) Then
                If Not m_ordco_destino.Equals(value) Then
                    m_ordco_destino = value
                    OnORDCO_DestinoChanged(m_ordco_destino, EventArgs.Empty)
                End If
            Else
                m_ordco_destino = value
                OnORDCO_DestinoChanged(m_ordco_destino, EventArgs.Empty)
    ...
    Public Property ORDCO_CotizacionProveedor() As String
        Get
            Return m_ordco_cotizacionproveedor
        End Get
        Set(ByVal value As String)
            If Not IsNothing(m_ordco_cotizacionproveedor) Then
                If Not m_ordco_cotizacionproveedor.Equals(value) Then
                    m_ordco_cotizacionproveedor = value
                    OnORDCO_CotizacionProveedorChanged(m_ordco_cotizacionproveedor, EventArgs.Empty)
                End If
            Else
                m_ordco_cotizacionproveedor = value
                OnORDCO_CotizacionProveedorChanged(m_ordco_cotizacionproveedor, EventArgs.Empty)
...
#Region " Eventos "
    ...
    Public Event ORDCO_DestinoDescripcionChanged As EventHandler
    ...
    Public Event ORDCO_DestinoChanged As EventHandler
    ...
    End Sub
    'm_ordco_destino_descripcion


    Public Sub OnORDCO_DestinoDescripcionChanged(ByVal sender As Object, ByVal e As EventArgs)
        ActualizarInstancia()
        RaiseEvent ORDCO_DestinoDescripcionChanged(sender, e)
    End Sub
	...
	End Sub
    Public Sub OnORDCO_DestinoChanged(ByVal sender As Object, ByVal e As EventArgs)
        ActualizarInstancia()
        RaiseEvent ORDCO_DestinoChanged(sender, e)
    End Sub

    'ORDCO_CotizacionProveedor 
    Public Sub OnORDCO_CotizacionProveedorChanged(ByVal sender As Object, ByVal e As EventArgs)
        ActualizarInstancia()
