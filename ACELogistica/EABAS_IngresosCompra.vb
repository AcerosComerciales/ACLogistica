         ...
         Else
            If m_tipos_codtipodocumento = ACEVentas.ETipos.getTipoComprobante(ACEVentas.ETipos.TipoComprobanteVenta.Ticket) Then
                ...
                ElseIf m_tipos_codtipodocumento = ACEVentas.ETipos.getTipoComprobante(ACEVentas.ETipos.TipoComprobanteVenta.Factura) Then
                    ...
                    Return String.Format("{0} {1}-{2}", m_tipos_documento, _
                                         m_ingco_serie.Trim().PadLeft(5, "0") _
                                         , m_ingco_numero.ToString().PadLeft(8, "0"))

                ElseIf m_tipos_codtipodocumento = ACEVentas.ETipos.getTipoComprobante(ACEVentas.ETipos.TipoComprobanteVenta.NotaCredito) Then
                ...
                Else
                    Return String.Format("{0} {1}-{2}", m_tipos_documento, _
                                         m_ingco_serie.Trim().PadLeft(3, "0") _
                                         , m_ingco_numero.ToString().PadLeft(7, "0"))
                End If
         End If
      End Get
   End Property
                ...
                If m_docco_codigo.Length > 12 Then
                    Select Case m_docco_codigo.Substring(0, 2)
                        Case ETipos.getTipoComprobante(ETipos.TipoComprobanteVenta.Boleta).Substring(3, 2)
                            Return String.Format("Bol {0}-{1}", m_docco_codigo.Substring(2, 5), m_docco_codigo.Substring(7, 8))
                        Case ETipos.getTipoComprobante(ETipos.TipoComprobanteVenta.Factura).Substring(3, 2)
                            Return String.Format("Fac {0}-{1}", m_docco_codigo.Substring(2, 5), m_docco_codigo.Substring(7, 8))
                        Case ETipos.getTipoComprobante(ETipos.TipoComprobanteVenta.NotaCredito).Substring(3, 2)
                            Return String.Format("Nota C. {0}-{1}", m_docco_codigo.Substring(2, 5), m_docco_codigo.Substring(7, 8))
                        ...
                        Case ETipos.getTipoComprobante(ETipos.TipoDocumento.GuiaRemisionRem).Substring(3, 2)
                            Return String.Format("GR {0}-{1}", m_docco_codigo.Substring(2, 5), m_docco_codigo.Substring(7, 8))
                        Case Else
                            Return "N.N."
                    End Select
                Else
                    Select Case m_docco_codigo.Substring(0, 2)
                        ...
                        Case ETipos.getTipoComprobante(ETipos.TipoComprobanteVenta.Ticket).Substring(3, 2)
                            Return String.Format("Ticket {0}-{1}", m_docco_codigo.Substring(2, 4), m_docco_codigo.Substring(6, 9))
                        Case ETipos.getTipoComprobante(ETipos.TipoDocumento.GuiaRemisionRem).Substring(3, 2)
                            Return String.Format("GR {0}-{1}", m_docco_codigo.Substring(2, 3), m_docco_codigo.Substring(5, 7))
                        Case Else
                            Return "N.N."
                    End Select
