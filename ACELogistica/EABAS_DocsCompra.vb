...
#Region " Variables "
   ...
   Private m_entid_nrodocumento As String
    ...
    Private m_ingresoreg As Boolean
    Private m_ingresoalmacen As String
...
#Region " Propiedades "
   ...
   End Property
    ...
    Public Property TIPOS_TipoPago() As String
        ...
        End Set
    End Property
    Public Property IngresoReg() As Boolean
        Get
            Return m_ingresoreg
        End Get
        ...
        End Set
    End Property
    Public Property IngresoAlmacen() As String
        Get
            Return m_ingresoalmacen
        End Get
        Set(ByVal value As String)
            If Not IsNothing(m_ingresoalmacen) Then
                If Not m_ingresoalmacen.Equals(value) Then
                    m_ingresoalmacen = value
                End If
            Else
                m_ingresoalmacen = value
            End If
