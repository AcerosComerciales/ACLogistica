...
#Region " Variables "
   ...
   Private m_modArticulo As Boolean = False
    Private bs_Destino As BindingSource

    Dim Direccion_id As Integer
      ...
      Try
         ...
         If managerABAS_CotizacionesCompra.Cargar(x_codigo, True) Then
            ...
            m_eabas_ordenescompra.ORDCO_CorreoProveedor = m_cotizacionc.COTCO_CorreoProveedor
                ...
                'ASIGNAMOS LA COTIZACION PROVEEDOR 
                m_eabas_ordenescompra.ORDCO_CotizacionProveedor = m_cotizacionc.COTCO_CotizacionProveedor
                AsignarBinding()
...
#Region " Metodos Utilitarios "
   ...
   Private Sub formatearGrilla()
      ...
      Try
         ...
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdDetalle, index, "Precio", "ORDCD_PrecioUnitario", "ORDCD_PrecioUnitario", 77, True, True, "System.Decimal", Parametros.GetParametro(EParametros.TipoParametros.pg_FMondo4d)) : index += 1
   ...
   End Sub
    ...
    Private Sub cargaCombos()
        Try
            ...
            'Dim _listdestinos As New List(Of EDestinos) 'Mal planteado ...
            'For Each item As EDestinos In Colecciones.ListDestinos
            '    bs_Destino.DataSource = item
            '    _listdestinos.Add(item)
            'Next
            Dim _listdestinos As New List(Of EDestinos)(Colecciones.ListDestinos)
            bs_Destino.DataSource = _listdestinos
            ACFramework.ACUtilitarios.ACCargaCombo(cargaCombos_, bs_Destino, "DESTINO_Descripcion", "DESTINO_Descripcion")
            'ACFramework.ACUtilitarios.ACCargaCombo(cargaCombos_, _listdestinos, "DESTINO_Descripcion", "DESTINO_Id")
    ...
    Private Sub setInstancia(ByVal _opcion As ACUtilitarios.ACSetInstancia)
      ...
      Select Case _opcion
         ...
         Case ACUtilitarios.ACSetInstancia.Modificado
            ...
            btnNuevoProveedor.Enabled = true'False
            actxaNroCotizacion.Enabled = False
            acTool.ACBtnAnularVisible = False
            actsbtnPrevisualizar.Visible = False
                 c1grdDetalle.AllowEditing = True
            ...
            btnNuevoProveedor.Enabled = False
                ...
                For Each item As ACSeguridad.EProcesos In _validate.ListProcesos
                    Select Case item.PROC_Codigo
                        Case Procesos.getProceso(Procesos.TipoProcesos.Abastecimientos_AnularOrdenCompra)
         ...
         If Not IsNothing(m_eabas_ordenescompra) Then
            If Not IsNothing(m_eabas_ordenescompra.ListABAS_OrdenesCompraDetalle) Then
               ...
               For Each Item As EABAS_OrdenesCompraDetalle In m_eabas_ordenescompra.ListABAS_OrdenesCompraDetalle
                  ...
                  _pesoTotal +=Item.ORDCD_PesoUnitario*Item.ORDCD_Cantidad 'Item.Articulo.ARTIC_Peso * Item.ORDCD_Cantidad
   ...
   Private Sub AsignarBinding()
      Try
         ...
         m_listBindHelper.Add(ACBindHelper.ACBind(actxnIGV, "Text", m_eabas_ordenescompra, "ORDCO_ImporteIgv"))
            ...
            'Asingmaos el Cotizacion A LOS TXT 
            m_listBindHelper.Add(ACBindHelper.ACBind(actx_CotizacionProveedor, "Text", m_eabas_ordenescompra, "ORDCO_CotizacionProveedor"))
         ...
         m_listBindHelper.Add(ACBindHelper.ACBind(actxaDocReferencia, "Text", m_eabas_ordenescompra, "DOCCO_Codigo"))
            ...
            m_listBindHelper.Add(ACBindHelper.ACBind(cargaCombos_, "SelectedValue", m_eabas_ordenescompra, "ORDCO_Destino"))
        Catch ex As Exception
         Throw ex
      End Try
   End Sub
             ...
             , ACControles.ACDialogos.LabelBotom.Si_No) = DialogResult.Yes Then
               ...
               m_eabas_ordenescompra.ALMAC_Id = GApp.Almacen
                    If m_eabas_ordenescompra.Nuevo Then
                        ...
                        m_eabas_ordenescompra.ORDCO_Destino = CType(bs_Destino.Current, EDestinos).DESTINO_Id
                        'm_eabas_ordenescompra.ORDCO_DESTINO_Descripcion = cargaCombos_.Text

                        'Asingar el numero de cotizcaion a la orden de compra 
                        m_eabas_ordenescompra.ORDCO_CotizacionProveedor = actx_CotizacionProveedor.Text
                    ...
                    m_eabas_ordenescompra.ORDCO_Destino = CType(bs_Destino.Current, EDestinos).DESTINO_Id
                    m_eabas_ordenescompra.ORDCO_DESTINO_Descripcion = CType(bs_Destino.Current, EDestinos).DESTINO_Descripcion
         ...
         If Not IsNothing(bs_abas_ordenescompra) Then
            If Not IsNothing(bs_abas_ordenescompra.Current) Then
               ...
               If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Seleccionar Registro: {0}", Me.Text) _
                   , String.Format("Desea seleccionar el registro con codigo: {0}? ", m_eabas_ordenescompra.ORDCO_Codigo) _
                   , ACControles.ACDialogos.LabelBotom.Si_No) = DialogResult.Yes Then
         ...
         If Not IsNothing(bs_abas_ordenescompra) Then
            If Not IsNothing(bs_abas_ordenescompra.Current) Then
               ...
               If managerABAS_OrdenesCompra.Cargar(x_codigo, True) Then
                  ...
                  bs_detabas_ordenescompra = New BindingSource
                        bs_detabas_ordenescompra.DataSource = m_eabas_ordenescompra.ListABAS_OrdenesCompraDetalle
                        cargaCombos_.Text = m_eabas_ordenescompra.ORDCO_DESTINO_Descripcion
                        c1grdDetalle.DataSource = bs_detabas_ordenescompra
                  bnavProductos.BindingSource = bs_detabas_ordenescompra
                  tabMantenimiento.SelectedTab = tabDatos
                  '' Cargar datos del Cliente
   ...
   Private Sub acTool_ACBtnImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles acTool.ACBtnImprimir_Click
      Try
         If Not IsNothing(bs_abas_ordenescompra) Then
                    ...
                    If Not IsNothing(bs_abas_ordenescompra.Current) Then
                        ...
                        If managerGenerarOrdenCompra.RegistroCompra(x_codigo) Then
                            ...
                            For Each Item As DataRow In managerGenerarOrdenCompra.Datos.Tables(0).Rows
                                ...
                                _dr("TIPOS_CodTipoMoneda") = Item("TIPOS_CodTipoMoneda")
                                _dr("TIPOS_CodTipoPago") = Item("TIPOS_CodTipoPago")
                                _dr("ALMAC_Direccion") = Item("ALMAC_Direccion")
                                ...
                                _dr("ORDCO_PesoTotal") = Item("ORDCO_PesoTotal")
                                _dr("ORDCO_Observaciones") = Item("ORDCO_Observaciones")
                ...
                ElseIf (GApp.EmpresaRUC = "20191731434 " Or GApp.EmpresaRUC = "20191731434") Then
                    If Not IsNothing(bs_abas_ordenescompra.Current) Then
                        Dim x_codigo As String = CType(bs_abas_ordenescompra.Current, EABAS_OrdenesCompra).ORDCO_Codigo
                        If managerGenerarOrdenCompra.RegistroCompra(x_codigo) Then
                            Dim dtDatos As New DTOrdenCompra
                            ...
                            For Each Item As DataRow In managerGenerarOrdenCompra.Datos.Tables(1).Rows
                                ...
                                dtDatos.OrdenCompraDetalle.Rows.Add(_dr)
                            Next
                            Dim Informe As New CROrdenCompraPromasa
                            Informe.SetDataSource(dtDatos)
                            Dim reporte As New RReportView(Informe)
                            reporte.ShowDialog()
                        End If
                ...
                Else
                    MessageBox.Show("NO SE IMPRIMIO")
         ...
         If Not IsNothing(bs_abas_ordenescompra) Then
            If Not IsNothing(bs_abas_ordenescompra.Current) Then
               If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Anular Registro: {0}", Me.Text) _
                  ...
                  If managerGenerarOrdenCompra.AnularOrdenCompra(CType(bs_abas_ordenescompra.Current, EABAS_OrdenesCompra).ORDCO_Codigo, CType(bs_abas_ordenescompra.Current, EABAS_OrdenesCompra).COTCO_Codigo, GApp.Usuario) Then
...
#Region " Ayuda para Proveedor "
   ...
   Private Sub actxaProvCodigo_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles actxaProvCodigo.KeyDown
      Try
            If e.KeyData = Keys.Enter And actxaProvCodigo.Text.ToString().Length >= 8 Then
                '' Cargar datos adicionales cliente
                If managerEntidades.Cargar(actxaProvCodigo.Text, EEntidades.TipoInicializacion.Proveedor) Then
                    '' Cargar datos del cliente
...
#Region " Ayudas "
   ...
   Private Sub actxaNroCotizacion_ACAyudaClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles actxaNroCotizacion.ACAyudaClick
      Try
         ...
         If frmCotiz.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
   ...
   Private Sub actxaDocReferencia_ACAyudaClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles actxaDocReferencia.ACAyudaClick
      Try
         If rbtnDocVenta.Checked Then
            Dim frmDocVenta As New CDocumentos() With {.StartPosition = FormStartPosition.CenterScreen, .MaximizeBox = False, .FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedSingle}
            If frmDocVenta.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
