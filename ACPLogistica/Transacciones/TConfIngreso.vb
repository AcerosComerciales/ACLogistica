      ...
      Try
         If managerGenerarRegMercTransito.BABAS_IngresosCompra.Cargar(x_codigo, x_almac_id, True) Then
            ...
            tabMantenimiento.SelectedTab = tabDatos
                ...
                txtOrdCompra.Text = m_eabas_ingresoscompra.ORDCO_Codigo
            '' Setear Valores
         Else
...
#Region " Utilitarios "
   ...
   Private Sub formatearGrilla()
      ...
      Try
         index = 1
         ACFrameworkC1.ACUtilitarios.ACFormatearGrilla(c1grdBusqueda, 1, 1, 13, 1, 2)
         ...
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "Guia Dev.", "Orden", "Orden", 150, True, False, "System.String") : index += 1
         ...
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "COTCO_Estado", "INGCO_Estado", "INGCO_Estado", 150, False, False, "System.String") : index += 1
          ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "Orden Compra", "ORDEN_Codigo", "ORDEN_Codigo", 150, True, False, "System.String") : index += 1
   ...
   Private Sub actsbtnAnularConfirmar_Click(sender As Object, e As EventArgs) Handles actsbtnAnularConfirmar.Click
      Try
         If ACControles.ACDialogos.ACMostrarMensajePregunta(String.Format("Anular Registro: {0}", Me.Text) _
            ...
            If managerGenerarRegMercTransito.AnularRegMercaderia_Log(GApp.Usuario,actxnNumero.TextLength) Then
...
End Sub
    ...
    Private Sub TConfIngreso_Load(sender As Object, e As EventArgs) Handles MyBase.Load
