...
Public Class CRKardexXArticulo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACPLogistica.CRKardexXArticulo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRKardexXArticulo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRKardexXArticulo = New CRKardexXArticulo()
        rpt.Site = Me.Site
        Return rpt
    End Function
