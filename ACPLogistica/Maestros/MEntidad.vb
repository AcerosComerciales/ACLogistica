...
#Region " Utilitarios "
      ...
      Try
         Select Case x_perfil
            ...
            Case EEntidades.TipoEntidad.ProveedoresLogistica
               Me.Text &= ": Proveedores de Logistica"
               acpnlTitulo.ACCaption &= ": Proveedores de Logistica"
               pnlFuncionEntidad.Visible = False
               tabAdicionales.Dock = DockStyle.Fill
               pnlDirecciones.Visible = False
               pnlDatosGen.Dock = DockStyle.Fill
               pnlTelefonos.Visible = False
               RemoveAll()
               AddPage(EEntidades.TipoEntidad.ProveedoresLogistica)
               tsBarra.Visible = True
               Me.Size = New Size(Me.Width, 430)
         End Select
   ...
   Private Sub setCheckFuncionEntidad()
      Try
         Select Case m_perfil
            ...
            Case EEntidades.TipoEntidad.ProveedoresLogistica
               chkListTipos.Items(9).Checked = True
               m_eentidades.Proveedor = New EProveedores
               m_eentidades.Proveedor.Instanciar(ACEInstancia.Nuevo)
               ABProveedor()
         End Select
   ...
   Private Sub formatearGrilla()
      ...
      Try
         ...
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "Tipo Doc.", "TIPOS_Documento", "TIPOS_Documento", 150, False, False, "System.String", "") : index += 1
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "R.U.C.", "ENTID_NroDocumento", "ENTID_NroDocumento", 150, True, False, "System.String", "") : index += 1
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, index, "Persona Contacto", "PROVE_Contacto", "PROVE_Contacto", 150, True, False, "System.String", "") : index += 1
         ...
         c1grdTelefonos.Styles.Alternate.BackColor = Color.LightGray
         ...
         c1grdDirecciones.Styles.Alternate.BackColor = Color.LightGray
   ...
   Private Sub cargarCombos()
      Try
         ...
         For Each Item As EVENT_ListaPrecios In Colecciones.ListaPrecios
            ...
            End If
         Next
         ACFramework.ACUtilitarios.ACCargaCombo(cmbCliListaPrecios, _list, "LPREC_Descripcion", "LPREC_Id")
         '' Vendedores
         ...
         Dim managerTiposEntidades As BRoles
         managerTiposEntidades = New BRoles
   ...
   Private Sub setDatos()
      Try
         ...
         actxaDescUbigeo.Text = m_eentidades.UBIGO_Descripcion
...
#Region " Cargar Datos "
   ...
   Private Sub AyudaUbigeo()
      Try
         ...
         If frmUbigeo.ShowDialog() = System.Windows.Forms.DialogResult.OK Then
   ...
   Private Sub AsignarBinding()
      Try
         ...
         If Not (IsNothing(m_eentidades.ENTID_Nombres)) Then
            If m_eentidades.ENTID_TipoEntidadPDT.Trim().Equals(Constantes.PersonaNatural) Then
         ...
         rbtJuridica.Checked = (m_eentidades.ENTID_TipoEntidadPDT = Constantes.PersonaJuridica)
         rbtNatural.Checked = Not (m_eentidades.ENTID_TipoEntidadPDT = Constantes.PersonaJuridica)
      Catch ex As Exception
         Throw ex
      End Try
   End Sub
   ...
   Private Sub ABProveedor()
      Try
         ...
         m_listBHProveedor.Add(ACBindHelper.ACBind(txtContacto, "Text", m_eentidades.Proveedor, "PROVE_Contacto"))
      Catch ex As Exception
         Throw ex
      End Try
   End Sub
   ...
   Private Sub cargar(ByVal x_codigo As String)
      Try
         If managerEntidades.Cargar(x_codigo, EEntidades.TipoInicializacion.EntTipos_Dir_Tel) Then
...
#End Region
   ...
   Private Function getCampo() As String
      Try
         If (rbtnNomComercial.Checked) Then
...
#Region " Metodos de Controles"
   ...
   Private Sub txt_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
      Try
         Me.actxaRazonSocial.Text = String.Format("{0} {1} {2}", txtApePaterno.Text, txtApeMaterno.Text, txtNombres.Text)
      Catch ex As Exception
      ...
      Try
         ...
         If e.Item.Checked Then
            Select Case e.Item.Index
               ...
               Case 10
                  AddPage(EEntidades.TipoEntidad.ProveedoresLogistica)
                  _tipe_codigo = EEntidades.TipoEntidad.ProveedoresLogistica
                  m_eentidades.Proveedor = New EProveedores
                  ABProveedor()
            End Select
         Else
...
#Region " Tool Bar "
   Private Sub acTool_ACBtnNuevo_Click(ByVal sender As Object, ByVal e As EventArgs) Handles acTool.ACBtnNuevo_Click
      Try
         ...
         '' Campos Obligatorios
         actxaCodigo.Focus()
         eprError.SetError(Me.actxaCodigo, "Campo Obligatorio")
         eprError.SetError(Me.cmbTipoDoc, "Campo Obligatorio")
         eprError.SetError(Me.actxaCodUbigeo, "Campo Obligatorio")
         eprError.SetError(Me.actxaNumDoc, "Campo Obligatorio")
         eprError.SetError(Me.actxaRazonSocial, "Campo Obligatorio")
         Me.KeyPreview = True
   ...
   Private Sub acTool_ACBtnGrabar_Click(ByVal sender As Object, ByVal e As EventArgs) Handles acTool.ACBtnGrabar_Click
      ...
      Try
         ...
         If ACFramework.ACUtilitarios.ACDatosOk(pnlDatos, msg) And getFuncionEntidad(msg) Then
            m_eentidades.ENTID_TipoEntidadPDT = IIf(rbtNatural.Checked, Constantes.PersonaNatural, Constantes.PersonaJuridica)
            If m_eentidades.Nuevo Then
               If rbtJuridica.Checked Then
                  m_eentidades.ENTID_Codigo = ETipos.getTipo(ETipos.TipoDocumentoIdentidad.RUC).Substring(3) & actxaNumDoc.Text
                  m_eentidades.TIPOS_CodTipoDocumento = ETipos.getTipo(ETipos.TipoDocumentoIdentidad.RUC)
                  If Not ACFramework.ACUtilitarios.ValidacionRUC(m_eentidades.ENTID_Codigo) Then
                     Throw New Exception("El numero de R.U.C. Ingresado no es Valido, revise nuevamente el numero e intentelo de nuevo")
                  End If
               Else
                  m_eentidades.ENTID_Codigo = cmbTipoDoc.SelectedValue.ToString().Substring(3).Trim() & actxaNumDoc.Text
               End If
            End If
            If m_eentidades.ENTID_TipoEntidadPDT.Equals(Constantes.PersonaNatural) Then
               m_eentidades.ENTID_PtrApeMaterno = txtApePaterno.Text.Trim().Length + 1
               ...
               m_eentidades.ENTID_RazonSocial = m_eentidades.ENTID_Nombres
...
#End Region
   ...
   Private Sub tsbtnRelacionados_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbtnRelacionados.Click
      Try
         If m_eentidades.Nuevo Then
            ACControles.ACDialogos.ACMostrarMensajeInformacion(String.Format("Información: {0}", Me.Text), "No se puede asignar un relacionado hasta que se grabe el registro")
         Else
            ...
            frmRela.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedSingle
