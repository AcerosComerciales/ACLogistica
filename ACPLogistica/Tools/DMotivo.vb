...
Public Class DMotivo
#Region " Variables "
   Private m_motivo As String
   Private m_tmovito As TDocumento
...
#Region " Constructores "
   Public Sub New(ByVal x_tmovito As TDocumento)
      ...
      Try
         ...
         Select Case m_tmovito
            ...
            Case TDocumento.Recibo
               acpnlTitulo.ACCaption = String.Format(acpnlTitulo.ACCaption, "Recibo Egreso/ngreso")
            Case Else
