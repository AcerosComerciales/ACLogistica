...
#Region " Metodos Utilitarios "
   ...
   Private Sub FormatearGrilla()
      ...
      Try
            ACFrameworkC1.ACUtilitarios.ACFormatearGrilla(c1grdBusqueda, 1, 1, 8, 1, 1)
         ...
         ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, _index, "Stock", "Stock", "Stock", 90, True, False, "System.Decimal", Parametros.GetParametro(EParametros.TipoParametros.pg_FMondo2d)) : _index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdBusqueda, _index, "Estado", "ARTIC_Descontinuado", "ARTIC_Descontinuado", 40, True, False, "System.String", "") : _index += 1
...
#Region " Metodos de Controles"
   ...
   Private Sub btnCargar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCargar.Click
      ...
      Try
         ...
         If rbtnSubLinea.Checked Then x_sublinea = cmbSubLinea.SelectedValue
         Dim _fecha As Date
         ...
         End If
            ...
            If managerGenerarReportes.LOG_STOCKSS_StockALaFecha(m_reporte, GApp.Periodo, GApp.Almacen, GApp.Zona, x_linea, x_sublinea, _fecha, chkTodos.Checked) Then
   ...
   Private Sub tsbtnprevisualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tsbtnprevisualizar.Click
      Try
         Utilitarios.reportToScreen(c1grdBusqueda, "Stock General a la Fecha", "Reporte", "", DateTime.Now, New Printing.PaperSize("A4", 827, 1169), New Printing.Margins(40, 40, 120, 40), , , True, False)
      Catch ex As Exception
...
#End Region
   ...
   Private Sub tsbtnExcel_Click(sender As Object, e As EventArgs) Handles tsbtnExcel.Click
      Try
         Utilitarios.ExportarXLS(c1grdBusqueda, "Stock a la Fecha")
      Catch ex As Exception
         ACControles.ACDialogos.ACMostrarMensajeError(String.Format("Error: {0}", Me.Text), "Ocurrio un error en el proceso Excel", ex)
      End Try
   End Sub

Private Sub RStocksArticulos_Load( sender As Object,  e As EventArgs) Handles MyBase.Load
