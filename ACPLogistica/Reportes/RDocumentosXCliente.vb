...
Public Class RDocumentosXCliente
#Region " Variables "
...
#Region " Metodos de Controles"
   ...
   Private Sub actxaCodCliente_ACAyudaClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles actxaCodCliente.ACAyudaClick
      Try
         AyudaEntidad(actxaCodCliente.Text, "ENTID_NroDocumento", "Razon Social", 1, ACEVentas.EEntidades.TipoEntidad.Clientes)
      Catch ex As Exception
   ...
   Private Sub actxaDescCliente_ACAyudaClick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles actxaDescCliente.ACAyudaClick
      Try
         AyudaEntidad(actxaDescCliente.Text, "ENTID_RazonSocial", "Razon Social", 1, ACEVentas.EEntidades.TipoEntidad.Clientes)
      Catch ex As Exception
...
#End Region
   ...
   Private Sub btnProcesar_Click(sender As Object, e As EventArgs) Handles btnProcesar.Click
      Try
         ...
         End If
         If managerReporte.RDocumentosXCliente(_fecini, _fecfin, GApp.Almacen, actxaCodCliente.Text, AcFecha.ACFechaChecked, actxaDescCliente.Text) Then
         Else
            ACControles.ACDialogos.ACMostrarMensajeInformacion(String.Format("Información: {0}", Me.Text), "Probablemente no existan datos para mostrar en este Cliente")
         End If
      Catch ex As Exception
         ACControles.ACDialogos.ACMostrarMensajeError(String.Format("Error: {0}", Me.Text), "Ocurrio un error en el proceso Reporte", ex)
      End Try
   End Sub
End Class