        ...
        Try
           ...
           'ACFramework.ACUtilitarios.ACCargaCombo(cmbTipoDocumento, listDoc, "TIPOS_Descripcion", "TIPOS_Codigo")
            ...
            If c1grdPuntosVentas.DataSource.Count>1 Then
                ...
                GroupBox1.Size()= New Size(949,48)
                Else 
                GroupBox3.Visible=False
                GroupBox1.Size()= New Size(1179,48)
...
Private Sub btnProcesar_Click( sender As Object,  e As EventArgs) Handles btnProcesar.Click
        Try
            ...
            list = new ArrayList()
             For Each itemAlPV As EPuntoVenta In CType(BS_PV.DataSource, List(Of EPuntoVenta))
                    If itemAlPV.Seleccionar Then
                           If m_reporte.Repor_Ventas_Todo(itemAlPV.PVENT_Id, actxaCliRazonSocial.Text, AcFecha.ACDtpFecha_De.Value.Date, AcFecha.ACDtpFecha_A.Value.Date, chkctodos.Checked,"Fac.") Then
            ...
            LiberarMemoria()
             If m_reporte.ControlPendietnesTotdo(GApp.Almacen, AcFecha.ACDtpFecha_De.Value.Date, AcFecha.ACDtpFecha_A.Value.Date,"guias") Then
                        ...
                        For items = 1 To c1grdReporte.Rows.Count - 1
                            For Each item_tabla As DataRow In m_reporte.DTReportes.Rows
                                If item_tabla("DOCVE_CODIGO") = c1grdReporte.Rows(items)("DOCVE_Codigo") Then
                                    c1grdReporte.Rows(_ik)("VENTAS_Condicion") = "Pendiente"
                                End If
                            Next
                            _ik += 1
                          Next
