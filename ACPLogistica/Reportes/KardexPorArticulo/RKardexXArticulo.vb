...
#Region " Metodos de Controles"
   ...
   Private Sub btnCargar_Click(sender As Object, e As EventArgs) Handles btnCargar.Click
      Try
         ...
         If m_reporte.KardexXArticulo(actxaProdCodigo.Text, GApp.Almacen, GApp.Periodo, GApp.Zona, AcFecha.ACDtpFecha_De.Value.Date, AcFecha.ACDtpFecha_A.Value.Date) Then
            m_cargado = True
