...
#Region " Variables "
    ...
    Private bs_guias As New BindingSource
    ...
    Public Sub New(ByVal x_icono As System.Drawing.Bitmap)
        ...
        Try
            ...
            If c1grdPuntosVentas.DataSource.Count>1 Then
                ...
                GroupBox1.Size()= New Size(709,48)
                Else 
                GroupBox4.Visible=False
                GroupBox1.Size()= New Size(936,48)
...
#Region "metodos"
    Private Sub formatearGrilla()
        ...
        Try
            ...
            index = 1
            ACFrameworkC1.ACUtilitarios.ACFormatearGrilla(c1grdReporte, 1, 1, 17, 1, 0)
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdReporte, index, "Doc. Relacion", "ORDEN_Codorigen", "ORDEN_Codorigen", 90, True, False, "System.String") : index += 1            
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdReporte, index, "Tipo Estado Entrega", "ORDEN_EstEntrega", "ORDEN_EstEntrega", 90, True, False, "System.String") : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdReporte, index, "Condicion", "Condicion", "Condicion", 90, True, False, "System.String") : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdReporte, index, "Impresiones", "ORDEN_Impresiones", "ORDEN_Impresiones", 90, True, False, "System.String") : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdReporte, index, "ORDEN_Codigo", "ORDEN_Codigo", "ORDEN_Codigo", 90, False, False, "System.String") : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdAlmacen, index, "Item", "ORDET_Item", "ORDET_Item", 80, False, False, "System.Integer", "#0") : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdAlmacen, index, "Unidad", "TIPOS_UnidadMedida", "TIPOS_UnidadMedida", 69, True, False, "System.String") : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdAlmacen, index, "Total Doc.", "ORDET_Cantidad", "ORDET_Cantidad", 75, True, False, "System.Decimal", Parametros.GetParametro(EParametros.TipoParametros.pg_FMondo2d)) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdAlmacen, index, "Entregado", "ORDET_CantidadEntregada", "ORDET_CantidadEntregada", 75, True, False, "System.Decimal", Parametros.GetParametro(EParametros.TipoParametros.pg_FMondo2d)) : index += 1
            ...
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdAlmacen, index, "Fecha Entrega", "ORDET_FecAlmacen", "ORDET_FecAlmacen", 80, True, False, "System.DateTime", Parametros.GetParametro(EParametros.TipoParametros.pg_FormatoFecha)) : index += 1
            ACFrameworkC1.ACUtilitarios.ACAgregarColumna(c1grdAlmacen, index, "Usuario", "ORDET_UsuarioAlmacen", "ORDET_UsuarioAlmacen", 191, True, False, "System.String") : index += 1
            ...
            ta.Font = New Font(c1grdAlmacen.Font, FontStyle.Regular)
            ...
            ua.Font = New Font(c1grdAlmacen.Font, FontStyle.Regular)
...
#End Region
    ...
    Private Sub btnProcesar_Click(sender As Object, e As EventArgs) Handles btnProcesar.Click 
        ...
        Try
            ...
            list = new ArrayList()
             For Each itemAlPV As EPuntoVenta In CType(BS_PV.DataSource, List(Of EPuntoVenta))
                    If itemAlPV.Seleccionar Then
                           If m_reporte.ObtenerOrdenes(GApp.Periodo,AcFecha.ACDtpFecha_De.Value.Date,AcFecha.ACDtpFecha_A.Value.Date, GApp.Almacen,ETipos.getTipoOrdenRecojo(ETipos.TipoOrdenRecojo.RecojoSalida), actxaCliRuc.Text, chkctodos.Checked,itemAlPV.PVENT_Id) Then
            ...
            LiberarMemoria()
              ...
              If m_reporte.ControlPendietnesTotdo(GApp.Almacen, AcFecha.ACDtpFecha_De.Value.Date, AcFecha.ACDtpFecha_A.Value.Date,"ordenes") Then
                        Dim _ik As Integer = 1
                        For items = 1 To c1grdReporte.Rows.Count - 1
                            For Each item_tabla As DataRow In m_reporte.DTReportes.Rows
                                If item_tabla("ORDEN_Codigo") = c1grdReporte.Rows(items)("ORDEN_Codigo") Then
                                    c1grdReporte.Rows(_ik)("Condicion") = "Pendiente"
                                End If
                            Next
                            _ik += 1
                          Next
    ...
    Private Sub c1grdReporte_OwnerDrawCell_1(sender As Object, e As OwnerDrawCellEventArgs) Handles c1grdReporte.OwnerDrawCell 
        Try
            ...
            End If
               ...
               If c1grdReporte.Cols(e.Col).Name = "Condicion" Then
              
                    If c1grdReporte.Rows(e.Row)("Condicion") ="Entregado" Then
    ...
    Private Sub tsbtnExcel_Click(sender As Object, e As EventArgs) Handles tsbtnExcel.Click 
        Try
            Utilitarios.ExportarXLS(c1grdReporte, "Ordenes de Salida")
        Catch ex As Exception
    ...
    Private Sub CargarAlmacenEntregas()
        ...
        Try
            Dim x_codigo As String = m_reporte.DIST_Ordenes.ORDEN_Codigo
            Dim m_edist_docsalmacen As New ACEVentas.EDIST_Ordenes

            Dim managerGenerarAlmacen As New BGenerarOrdenes(GApp.Periodo)
            If managerGenerarAlmacen.cargar(x_codigo, GApp.Almacen, True, True) Then

                ' Cargar el detalle de la guia de remision
                m_edist_docsalmacen.ListDIST_OrdenesDetalle = New List(Of ACEVentas.EDIST_OrdenesDetalle)

            End If

            bs_docalmacenentregas = New BindingSource
            bs_docalmacenentregas.DataSource = managerGenerarAlmacen.DIST_Ordenes.ListDIST_OrdenesDetalle
            BindingNavigator2.BindingSource = bs_docalmacenentregas
...
#Region "Cargar Datos"
    Private Sub AsignarBinding()
        Try
            ...
            If m_reporte.DIST_Ordenes.ORDEN_FechaDocumento.Year < 1700 Then m_reporte.DIST_Ordenes.ORDEN_FechaDocumento = DateTime.Now
            m_listBindHelper.Add(ACBindHelper.ACBind(dtpfechaDoc, "Value", m_reporte.DIST_Ordenes, "ORDEN_FechaDocumento"))
            m_listBindHelper.Add(ACBindHelper.ACBind(cmbPuntoVenta, "SelectedValue", m_reporte.DIST_Ordenes, "PVENT_IdOrigen"))
...
#Region "Procesos"
    ...
    Private Sub cargarGuia(ByVal x_codigo As String)
        Try
            If m_reporte.CargarOrdenes(x_codigo) Then
                ...
                _generarguias.LOG_DISTSS_GuiasXOrden(m_reporte.DIST_Ordenes.ORDEN_Codigo, GApp.Almacen)
                ...
                ''''''''''''''''
                ''cargar pendientes
                If Not  m_reporte.DIST_Ordenes.ORDEN_Estado.Equals("X") 
                    cargarPendientes()
                    Else 
                   DIM ListVacia = New List(Of ACEVentas.EDIST_GuiasRemisionDetalle)
                    c1grdPendientes.DataSource=ListVacia
                End If
                ''''''''''''''''
                ''cargar Adicionales
                cargarusuarioCreacion(m_reporte.DIST_Ordenes.ORDEN_UsrCrea)
                cargarusuarioImpresion(m_reporte.DIST_Ordenes.ORDEN_UsrImpresion)
                dtpFecCreacion.Value= m_reporte.DIST_Ordenes.ORDEN_FecCrea
                dtpFecCreacion.Enabled = False
                dtpHoraCreacion.Value=m_reporte.DIST_Ordenes.ORDEN_FecCrea
                dtpHoraCreacion.Enabled = False
                
                 If m_reporte.DIST_Ordenes.ORDEN_FecImpresion.Year > 1900 then
                    dtpFecImpresion.value =m_reporte.DIST_Ordenes.ORDEN_FecImpresion
                    dtpFecImpresion.Enabled = False
                    dtpHoraImpresion.Value = m_reporte.DIST_Ordenes.ORDEN_FecImpresion
                    dtpHoraImpresion.Enabled = False
                     dtpFecImpresion.Visible = True
                    dtpHoraImpresion.Visible = true
                    else
                    dtpFecImpresion.Visible = False
                    dtpHoraImpresion.Visible = False
                End If
               '''''''''''''''''''
        ...
        End Try
    End Sub
    Private Sub cargarusuarioCreacion(ByVal x_entid_codigo As String)
        Try
            If managerEntidades.Cargar(x_entid_codigo, EEntidades.TipoInicializacion.EntTipos_Dir_Tel) Then
                actxaCodUsrCreacion.Text =  managerEntidades.Entidades.ENTID_Codigo
                actxaDescUsrCreacion.Text =managerEntidades.Entidades.ENTID_RazonSocial
            End If
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Private Sub cargarusuarioImpresion(ByVal x_entid_codigo As String)
        Try
            If managerEntidades.Cargar(x_entid_codigo, EEntidades.TipoInicializacion.EntTipos_Dir_Tel) Then
                actxaCodUsrImpresion.Text = managerEntidades.Entidades.ENTID_Codigo
                actxaDescUsrImpresion.Text = managerEntidades.Entidades.ENTID_RazonSocial
             End If
        Catch ex As Exception
            Throw ex
        End Try
        ...
        Try
            ...
            if m_reporte.Guias_VerificacionControlOrdenes(GApp.Almacen,m_reporte.DIST_Ordenes.ORDEN_Codigo,GApp.EUsuario.USER_CodUsr,M_reporte.DIST_Ordenes.TIPOS_CodTipoOrden,"1") Then
                    ...
                    If ACControles.ACDialogos.ACMostrarMensajeSatisfactorio(String.Format("Información:"), String.Format("Verificacion Correcta" ))
                        ...
                        If (columna-10 <=0)Then
                            c1grdReporte.TopRow=1
                            c1grdReporte.Select(columna,0)
                        Else if(Columna =c1grdReporte.Rows.Count)
                   ...
                   ACControles.ACDialogos.ACMostrarMensajeError(String.Format("Error: {0}", Me.Text), "Ocurrio un error al revisar la orden")   
    ...
    Private Sub cargarPendientes()
        Try
            ...
            ''If m_event_docsventa.DOCVE_EstEntrega.Equals(Colecciones.GetEntrega(Colecciones.TEntrega.Pendiente)) Then
                ...
                If managerGenerarGuias.cargarSoloorden(x_codigo, GApp.Almacen, True, False) Then
...
Private Sub c1grdGuiasRemision_OwnerDrawCell( sender As Object,  e As OwnerDrawCellEventArgs) Handles c1grdGuiasRemision.OwnerDrawCell
         ...
         If c1grdGuiasRemision.Rows(e.Row)("GUIAR_Estado") = ACELogistica.EDIST_GuiasRemision.getEstado(ACELogistica.EDIST_GuiasRemision.Estado.anulado) Then
