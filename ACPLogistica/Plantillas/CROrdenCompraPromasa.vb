...
Public Class CROrdenCompraPromasa
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CROrdenCompraPromasa.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACPLogistica.CROrdenCompraPromasa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCROrdenCompraPromasa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CROrdenCompraPromasa = New CROrdenCompraPromasa()
        rpt.Site = Me.Site
        Return rpt
    End Function
