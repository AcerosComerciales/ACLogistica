...
Public Class CRCotizCompra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ACPLogistica.CRCotizCompra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRCotizCompra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRCotizCompra = New CRCotizCompra()
        rpt.Site = Me.Site
        Return rpt
    End Function
