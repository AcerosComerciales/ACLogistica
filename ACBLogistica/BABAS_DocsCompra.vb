...
#Region " Metodos "
   ...
   Public Function Busqueda(ByVal x_zonas_codigo As String, ByVal x_sucur_id As Short, ByVal x_cadena As String, ByVal x_opcion As Short, ByVal x_todos As Boolean, ByVal x_fecini As Date, ByVal x_fecfin As Date) As Boolean
    ...
    End Function
    ''' <summary> 
    ''' Capa de Negocio: LOG_ABAS_BusDocsCompra
    ''' </summary>
    ...
    ''' <returns></returns> 
    ''' <remarks></remarks> 
    Public Function BusDocsCompra(ByVal x_fecini As Date, ByVal x_fecfin As Date, ByVal x_almac_id As Long, ByVal x_cadena As String, ByVal x_todos As Boolean) As Boolean
        m_listABAS_DocsCompra = New List(Of EABAS_DocsCompra)
        Try
            Return d_abas_docscompra.LOG_ABASS_BusDocsCompra(m_listABAS_DocsCompra, x_fecini, x_fecfin, x_almac_id, x_cadena, x_todos)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
   ...
   End Function
    ...
    Public Function Busqueda(ByVal x_todos As Boolean, ByVal x_fecini As DateTime, ByVal x_fecfin As DateTime _
                             , ByVal x_opcion As Short, ByRef x_cadena As String) As Boolean
        Try
            Dim _join As New List(Of ACJoin)
            _join.Add(New ACJoin(EEntidades.Esquema, EEntidades.Tabla, "Ent", ACJoin.TipoJoin.Inner _
                               , New ACCampos() {New ACCampos("ENTID_Codigo", "ENTID_CodigoProveedor")} _
            ...
            If x_opcion = 0 Then
                _where.Add("ENTID_CodigoProveedor", New ACWhere(x_cadena, ACWhere.TipoWhere._Like))

            Else

                _where.Add("ORDEN_Codigo", New ACWhere(x_cadena, ACWhere.TipoWhere._Like))
            End If

            _where.Add("DOCCO_FechaDocumento", New ACWhere(x_fecini, x_fecfin, ACWhere.TipoWhere.Between))
            ' _where.Add("DOCCO_Destino", New ACWhere(If Gapp.)
            _where.Add(ACWhere.OrderBy, New ACWhere(New ACOrderBy() {New ACOrderBy("DOCCO_Codigo", ACOrderBy.Ordenamiento.Ascendente)}))
            If Not x_todos Then
                _where.Add("DOCCO_Estado", New ACWhere(EABAS_IngresosCompra.getEstado(EABAS_IngresosCompra.Estado.Ingresado), ACWhere.TipoWhere.Igual))
            End If
    ...
    End Function
    Public Function Busqueda(ByVal x_todos As Boolean, ByVal x_fecini As DateTime, ByVal x_fecfin As DateTime _
                             , ByVal x_opcion As Short, ByRef x_cadena As String, ByRef x_destino As Integer) As Boolean
        Try
            Dim _join As New List(Of ACJoin)
            _join.Add(New ACJoin(EEntidades.Esquema, EEntidades.Tabla, "Ent", ACJoin.TipoJoin.Inner _
                               , New ACCampos() {New ACCampos("ENTID_Codigo", "ENTID_CodigoProveedor")} _
            ...
            _join.Add(New ACJoin(ACEVentas.ETipos.Esquema, ACEVentas.ETipos.Tabla, "TPag", ACJoin.TipoJoin.Inner _
                               , New ACCampos() {New ACCampos("TIPOS_Codigo", "TIPOS_CodTipoPago")} _
                               , New ACCampos() {New ACCampos("TIPOS_Descripcion", "TIPOS_TipoPago")}))
            _join.Add(New ACJoin(EABAS_IngresosCompra.Esquema, EABAS_IngresosCompra.Tabla, "ICom", ACJoin.TipoJoin.Left _
                               , New ACCampos() {New ACCampos("DOCCO_Codigo", "DOCCO_Codigo")} _
                               , New ACCampos() {New ACCampos("DOCCO_Codigo", "IngresoAlmacen")}))
            Dim _where As New Hashtable()
            ...
            _where.Add("DOCCO_FechaDocumento", New ACWhere(x_fecini, x_fecfin, ACWhere.TipoWhere.Between))
            _where.Add("DOCCO_Destino", New ACWhere(x_destino, ACWhere.TipoWhere.Igual))
            _where.Add(ACWhere.OrderBy, New ACWhere(New ACOrderBy() {New ACOrderBy("DOCCO_Codigo", ACOrderBy.Ordenamiento.Ascendente)}))
            If Not x_todos Then
                _where.Add("DOCCO_Estado", New ACWhere(EABAS_IngresosCompra.getEstado(EABAS_IngresosCompra.Estado.Ingresado), ACWhere.TipoWhere.Igual))
            End If
      ...
      Try
         ...
         If Cargar(_join, _where) Then
            If x_detalle Then
               ...
               _joinDet.Add(New ACJoin(ACEVentas.ETipos.Esquema, ACEVentas.ETipos.Tabla, "TDes", ACJoin.TipoJoin.Inner _
