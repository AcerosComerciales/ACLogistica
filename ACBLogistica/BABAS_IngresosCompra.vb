...
#Region " Metodos "
   ...
   End Function
    ...
    Public Function ConsultaIT(ByVal x_cadena As String, ByVal x_opcion As Short, ByVal x_tipo As String, ByVal x_todos As Boolean, ByVal x_fecini As Date, ByVal x_fecfin As Date) As Boolean
      m_listABAS_IngresosCompra = New List(Of EABAS_IngresosCompra)
      Try
         Return d_abas_ingresoscompra.LOG_INGSS_ConsultaIT(m_listABAS_IngresosCompra, x_cadena,x_opcion, x_tipo, x_todos, x_fecini, x_fecfin)
      Catch ex As Exception
         Throw ex
      End Try
   End Function
