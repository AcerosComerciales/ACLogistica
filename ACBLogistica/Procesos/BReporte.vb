...
#Region " Metodos "
    ...
    End Function
    ''' <summary> 
    ''' Capa de Negocio: CTRL_STOCKSS_KardexXArticuloStockFisico
    ''' </summary> 
    ''' <param name="x_artic_codigo">Parametro 1: </param> 
    ''' <param name="x_almac_id">Parametro 2: </param> 
    ''' <param name="x_perio_codigo">Parametro 3: </param> 
    ...
    ''' <returns></returns> 
    ''' <remarks></remarks> 
    Public Function KardexXArticuloStockFisico(ByVal x_artic_codigo As String, ByVal x_almac_id As Integer, ByVal x_perio_codigo As String, ByVal x_zonas_codigo As String, ByVal x_fecini As Date, ByVal x_fecfin As Date) As Boolean
        Try
            m_dttable = New DataTable
            Return d_reporte.CTRL_STOCKSS_KardexXArticuloStockFisico(m_dttable, x_artic_codigo, x_almac_id, x_perio_codigo, x_zonas_codigo, x_fecini, x_fecfin)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Function ALMA_REPOSS_TOTAL_AlmacenExterno(ByRef x_dtdata As DataSet, ByVal x_fecIni As DateTime, ByVal x_fecFin As DateTime) As DataSet
        x_dtdata = New DataSet
        Try
            Return d_reporte.ALMA_REPOSS_TOTAL_AlmacenExterno(x_fecIni, x_fecFin)
        Catch ex As Exception
            Throw ex
        End Try
    End Function

    Public Function ALMA_REPOSS_TOTAL_AlmacenLocal(ByRef x_dtdata As DataSet, ByVal x_fecIni As DateTime, ByVal x_fecFin As DateTime) As DataSet
        x_dtdata = New DataSet
        Try
            Return d_reporte.ALMA_REPOSS_TOTAL_AlmacenLocal(x_fecIni, x_fecFin)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    Public Function ALMA_REPOSS_TOTAL_Almacen(ByRef x_dtdata As DataSet, ByVal x_fecIni As DateTime, ByVal x_fecFin As DateTime) As DataSet
        x_dtdata = New DataSet
        Try
            Return d_reporte.ALMA_REPOSS_TOTAL_Almacen(x_fecIni, x_fecFin)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    'Funcion asincrona para esto 
    ...
    Public Function LOG_ABAS_CuadrePendientesDocsCompras(ByVal x_fecini As Date, ByVal x_fecfin As Date, ByVal x_almac_id As Short, Optional ByVal x_artic_codigo As String = Nothing, Optional ByVal x_entid_codigo As String = Nothing) As Boolean
        m_listabas_docscompradetalle = New List(Of EABAS_DocsCompraDetalle)
        Try

            Return d_reporte.LOG_ABAS_CuadrePendientesDocsCompra(m_listabas_docscompradetalle, x_fecini, x_fecfin, x_almac_id, x_artic_codigo, x_entid_codigo)
        Catch ex As Exception
            Throw ex
        End Try
    End Function

    Public Function LOG_ABAS_CuadrePendientesOrdenesCompra(ByVal x_fecini As Date, ByVal x_fecfin As Date, ByVal x_almac_id As Short, Optional ByVal x_artic_codigo As String = Nothing, Optional ByVal x_entid_codigo As String = Nothing) As Boolean
        m_listabas_docscompradetalle = New List(Of EABAS_DocsCompraDetalle)
        Try

            Return d_reporte.LOG_ABAS_CuadrePendientesOrdenesCompra(m_listabas_docscompradetalle, x_fecini, x_fecfin, x_almac_id, x_artic_codigo, x_entid_codigo)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
