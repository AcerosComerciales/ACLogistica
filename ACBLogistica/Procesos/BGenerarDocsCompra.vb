...
#Region " Variables "
   ...
   Private m_eabas_docscompra As EABAS_DocsCompra
    ...
    Private m_listABASnotas_credito As List(Of EABAS_DocsCompra)
#End Region
...
#Region " Propiedades "
   ...
   Public Property ListABAS_OrdenesCompra() As List(Of EABAS_OrdenesCompra)
      ...
      End Set
    End Property
    Public Property ListABAS_NotasCreditoCompra() As List(Of EABAS_DocsCompra)
        Get
            Return m_listABASnotas_credito
        End Get
        Set(ByVal value As List(Of EABAS_DocsCompra))
            m_listABASnotas_credito = value
        End Set
    End Property
#End Region
...
#Region " Metodos "
   ...
   End Function
    ''' <summary> 
    ''' Capa de Negocio: ABAS_DOCCOSS_DocumentosXNotaCredito
    ''' </summary>
    ''' <param name="x_docve_codigo">Parametro 1: </param> 
    ''' <returns></returns> 
    ''' <remarks></remarks> 
    Public Function DocumentosRelacionados(ByVal x_docco_codigo As String, ByVal x_entid_codigo As String) As Boolean
        m_listABASnotas_credito = New List(Of EABAS_DocsCompra)

        Try
            Dim _abas_docscompra As New BABAS_DocsCompra
            If _abas_docscompra.DocumentosRelacionados(x_docco_codigo, x_entid_codigo) Then
                ' m_event_docsventa.ListVENT_DocsVenta = _vent_docsventa.ListVENT_DocsVenta
                m_listABASnotas_credito = _abas_docscompra.ListABAS_NotasCreditoCompra
                Return True
            End If
            Return False
        Catch ex As Exception
