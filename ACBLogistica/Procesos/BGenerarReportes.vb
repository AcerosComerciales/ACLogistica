...
#Region " Metodos "
   ...
   End Function
    ...
    ''' <returns></returns> 
    ''' <remarks></remarks> 
    Public Function LOG_STOCKSS_StockALaFecha(ByRef x_datatable As DataTable, ByVal x_perio_codigo As String, ByVal x_almac_id As Short, ByVal x_zonas_codigo As String, ByVal x_linea As String, ByVal x_sublinea As String, ByVal x_fecha As DateTime, ByVal x_todos As Boolean) As Boolean
        Try
            Return d_generarreportes.LOG_STOCKSS_StockALaFecha(x_datatable, x_perio_codigo, x_almac_id, x_zonas_codigo, x_linea, x_sublinea, x_fecha, x_todos)
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function ComprasXLinea(ByVal x_linea_codigo As String, ByVal x_fecini As DateTime, ByVal x_fecfin As DateTime, ByRef x_datos As DataSet, ByVal x_destino As Short) As Boolean
      x_datos = New DataSet()
      Try
         Return d_generarreportes.GetComprasXLinea(x_linea_codigo, x_fecini, x_fecfin, x_datos,x_destino)
      Catch ex As Exception
         Throw ex
      End Try
   End Function
