...
#Region " Metodos "
   ...
   Public Function GrabaCotizCompra(ByVal x_usuario As String, ByRef x_msg As String) As Boolean
      Try
         ...
         If Not m_bABAS_CotizacionesCompra.ABAS_CotizacionesCompra.PEDIDCO_Codigo.Equals("") Then
            '' Cambiar de estado a cotización
            Dim m_pedidocompra As New BABAS_PedidosCompra
            m_pedidocompra.ABAS_PedidosCompra = New EABAS_PedidosCompra()
            m_pedidocompra.ABAS_PedidosCompra.PEDID_Codigo = m_bABAS_CotizacionesCompra.ABAS_CotizacionesCompra.PEDIDCO_Codigo
            m_pedidocompra.ABAS_PedidosCompra.PEDID_Estado = EABAS_PedidosCompra.getEstado(EABAS_PedidosCompra.Estado.Confirmado)
            m_pedidocompra.Guardar(x_usuario)
         End If
