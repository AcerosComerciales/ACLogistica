   ...
   Public Function Cargar(ByVal x_ordco_codigo As String, ByVal x_detalle As Boolean) As Boolean
      Try
         Dim _join As New List(Of ACJoin)
            ...
            _join.Add(New ACJoin(EDestinos.Esquema, EDestinos.Tabla, "Dest", ACJoin.TipoJoin.Left _
                                 , New ACCampos() {New ACCampos("DESTINO_Id", "ORDCO_Destino")} _
                                 , New ACCampos() {New ACCampos("Destino_Descripcion", "ORDCO_DESTINO_Descripcion") _
                                                   , New ACCampos("DESTINO_Descripcion", "Destino_Descripcion_")}))
            Dim _where As New Hashtable()
         ...
         If Cargar(_join, _where) Then
            If x_detalle Then
               Dim m_babas_ordenescompradetalle As New BABAS_OrdenesCompraDetalle
                    ...
                    Dim _joinDet_ As New List(Of ACJoin)
                    ...
                    _joinDet.Add(New ACJoin(ACEVentas.ETipos.Esquema, ACEVentas.ETipos.Tabla, "Uni", "Art", ACJoin.TipoJoin.Inner _
