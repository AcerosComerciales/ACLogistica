...
#Region " Procedimientos Almacenados "
   ...
   End Function
    ...
    ''' <returns></returns> 
    ''' <remarks></remarks> 
    Public Function LOG_STOCKSS_StockALaFecha(ByRef x_datatable As DataTable, ByVal x_perio_codigo As String, ByVal x_almac_id As Short, ByVal x_zonas_codigo As String, ByVal x_linea As String, ByVal x_sublinea As String, ByVal x_fecha As Date, ByVal x_todos As Boolean) As Boolean
        Try
    ...
    Public Function GetComprasXLinea(ByVal x_linea_codigo As String, ByVal x_fecini As DateTime, ByVal x_fecfin As DateTime, ByRef x_datos As DataSet, ByVal x_destino As Short) As Boolean
      Try
            'DAEnterprise.AsignarProcedure(getSelect(x_linea_codigo, x_fecini, x_fecfin,x_destino), CommandType.Text)
            DAEnterprise.AsignarProcedure("LOG_ABASSS_ComprasXLinea")
            DAEnterprise.AgregarParametro("@Linea", x_linea_codigo, DbType.String, 10)
          DAEnterprise.AgregarParametro("@Destino", x_destino, DbType.Int16, 2)
...
#Region " Adicionales "
   ...
   Private Function getSelect(ByVal x_linea_codigo As String, ByVal x_fecini As DateTime, ByVal x_fecfin As DateTime, ByVal x_destino As Short) As String
      Dim sql As String = ""
      Try

         App.Inicializar()
         
        sql &= String.Format(App.Hash("DGenerarReportes.GetArticulosXLinea").ToString(), x_linea_codigo, x_fecini.ToString(m_formatofecha), x_fecfin.ToString(m_formatofecha),x_destino)
         Return sql
      Catch ex As Exception
         Throw ex
      End Try
