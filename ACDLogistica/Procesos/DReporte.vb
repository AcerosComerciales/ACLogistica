...
#Region " Metodos "
   ...
   Public Function CTRL_STOCKSS_KardexXArticulo(ByRef x_data As DataTable, ByVal x_artic_codigo As String, ByVal x_almac_id As Integer, ByVal x_perio_codigo As String, ByVal x_zonas_codigo As String, ByVal x_fecini As Date, ByVal x_fecfin As Date) As Boolean
    ...
    End Function
    ''' <summary> 
    ''' Capa de Datos: CTRL_STOCKSS_KardexXArticuloStockFisico
    ''' </summary>
    ''' <param name="x_artic_codigo">Parametro 1: </param> 
    ''' <param name="x_almac_id">Parametro 2: </param> 
    ''' <param name="x_perio_codigo">Parametro 3: </param> 
    ...
    ''' <returns></returns> 
    ''' <remarks></remarks> 
    Public Function CTRL_STOCKSS_KardexXArticuloStockFisico(ByRef x_data As DataTable, ByVal x_artic_codigo As String, ByVal x_almac_id As Integer, ByVal x_perio_codigo As String, ByVal x_zonas_codigo As String, ByVal x_fecini As Date, ByVal x_fecfin As Date) As Boolean
        Try
            DAEnterprise.AsignarProcedure("CTRL_STOCKSS_KardexXArticuloStockFisico")
            DAEnterprise.AgregarParametro("@ARTIC_Codigo", x_artic_codigo, DbType.String, 14)
            DAEnterprise.AgregarParametro("@ALMAC_Id", x_almac_id, DbType.Int32, 4)
            DAEnterprise.AgregarParametro("@PERIO_Codigo", x_perio_codigo, DbType.String, 4)
            DAEnterprise.AgregarParametro("@ZONAS_Codigo", x_zonas_codigo, DbType.String, 5)
   ...
   End Function
    ...
    Public Function LOG_ABAS_CuadrePendientesDocsCompra(ByVal m_listabas_docscompradetalle As List(Of EABAS_DocsCompraDetalle), ByVal x_fecini As Date, ByVal x_fecfin As Date, ByVal x_almac_id As Short, ByVal x_artic_codigo As String, ByVal x_entid_codigo As String) As Boolean
        Try
            DAEnterprise.AsignarProcedure("LOG_ABAS_CuadrePendientesDocsCompra")
            DAEnterprise.AgregarParametro("@FecIni", x_fecini, DbType.DateTime, 8)
            DAEnterprise.AgregarParametro("@FecFin", x_fecfin, DbType.DateTime, 8)
        ...
        End Try
    End Function
    ''ALMA_REPOSS_TOTAL_Almacen
    Public Function ALMA_REPOSS_TOTAL_Almacen(ByVal x_fecini As Date, ByVal x_fecfin As Date) As DataSet
        Try
            DAEnterprise.AsignarProcedure("ALMA_REPOSS_TOTAL_Almacen")
            DAEnterprise.AgregarParametro("@FecIni", x_fecini, DbType.DateTime, 8)
            DAEnterprise.AgregarParametro("@FecFin", x_fecfin, DbType.DateTime, 8)
            DAEnterprise.CommandTimeOut = 0

            Dim x_dtdata As DataSet = DAEnterprise.ExecuteDataSet()
            'Return x_dtdata.Tables(0).Rows.Count > 0
            Return x_dtdata
        Catch ex As Exception
            Throw ex
        End Try
    End Function
    Public Function ALMA_REPOSS_TOTAL_AlmacenExterno(ByVal x_fecini As Date, ByVal x_fecfin As Date) As DataSet
        Try
            DAEnterprise.AsignarProcedure("ALMA_REPOSS_TOTAL_AlmacenExterno")
            DAEnterprise.AgregarParametro("@FecIni", x_fecini, DbType.DateTime, 8)
            DAEnterprise.AgregarParametro("@FecFin", x_fecfin, DbType.DateTime, 8)
            DAEnterprise.CommandTimeOut = 0

            Dim ds As DataSet = DAEnterprise.ExecuteDataSet()
            Return ds
    ...
    Public Function ALMA_REPOSS_TOTAL_AlmacenLocal(ByVal x_fecini As Date, ByVal x_fecfin As Date) As DataSet
        Try
            DAEnterprise.AsignarProcedure("ALMA_REPOSS_TOTAL_AlmacenLocal")
            DAEnterprise.AgregarParametro("@FecIni", x_fecini, DbType.DateTime, 8)
            DAEnterprise.AgregarParametro("@FecFin", x_fecfin, DbType.DateTime, 8)
            DAEnterprise.CommandTimeOut = 0
    ...
    'Public Function ALMA_REPOSS_TOTAL_Almacen(ByVal x_fecini As Date, ByVal x_fecfin As Date) As List(Of DataSet)
    ...
    '        ds = DAEnterprise.ExecuteDataSet()
    ...
    Public Function LOG_ABAS_CuadrePendientesOrdenesCompra(ByVal m_listabas_docscompradetalle As List(Of EABAS_DocsCompraDetalle), ByVal x_fecini As Date, ByVal x_fecfin As Date, ByVal x_almac_id As Short, ByVal x_artic_codigo As String, ByVal x_entid_codigo As String) As Boolean
        Try
            DAEnterprise.AsignarProcedure("LOG_ABAS_CuadrePendientesOrdenesCompras")
            DAEnterprise.AgregarParametro("@FecIni", x_fecini, DbType.DateTime, 8)
            DAEnterprise.AgregarParametro("@FecFin", x_fecfin, DbType.DateTime, 8)
            DAEnterprise.AgregarParametro("@ALMAC_Id", x_almac_id, DbType.Int16, 2)
            DAEnterprise.AgregarParametro("@ARTIC_Codigo", x_artic_codigo, DbType.String, 14)
